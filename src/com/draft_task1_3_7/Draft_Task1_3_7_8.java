...
//        Пример _ ППППППППППППППППППППППППППППППППППП  //  СДЕЛАН ОКОНЧАТЕЛЬНО, ОТПРАВЛЕН В ЭТОМ ВИДЕ !!!!! С ПЕРЕЗАПИСЬЮ, БЕЗ ПЕРЕЗАПИСИ
...
////        Пример 5 ППППППППППППППППППППППППППППППППППП  //  СДЕЛАНО БЕЗ ПЕРЕЗАПИСИ НО КАЖДЫЙ ИЗ СНИМКОВ СОХРАНЯЕТСЯ НА ПРЕДЫДУЩИЙ С ПЕРЕЗАПИСЬЮ, УДАЛИТЬ ЛИШНИЕ СТРОКИ
//public class com.draft_task1_3_7.Draft_Task1_3_7_8 {
//    public static void main(String[] args) throws IOException, ParseException {
//        System.out.println("""
//            Задание:\s
