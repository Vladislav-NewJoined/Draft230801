...
//public class com.draft_task1_3_8.Draft_Task1_3_8_1_Peregruzka_metodov {
//    public static void main(String[] args) {
//        System.out.println("""
//            Задание:\s
//            1. Реализуйте методы, max(x,y) - для целых, вещественных чисел, и для строк (в
...
//            Решение:\s""");
//
//        com.draft_task1_3_8.MaxValue maxValue = new com.draft_task1_3_8.MaxValue();
//
...
//
//    //  Реализуем перегруженные методы
//    static void max(com.draft_task1_3_8.MaxValue balalaika, String price, int b, int x, int y) {
//
...
//    }
//
//    static void max(com.draft_task1_3_8.MaxValue balalaika, String price, int b, double x, double y) {
//
////        String price = "199";  // если не закомментить, тогда не нужно входного параметра метода String price,
//        price = "199";
//        double priceDouble = Double.parseDouble(price);
...
//    }
//
//    static void max(com.draft_task1_3_8.MaxValue balalaika, String price, int b, String firstStr, String secondStr) {
//
////        String price = "199";  // если не закомментить, тогда не нужно входного параметра метода String price,
//        price = "199";
//        double priceDouble = Double.parseDouble(price);
...
//}
//
//class com.draft_task1_3_8.MaxValue {
//    double price;
//    double b;
//    int maxInt;
//    double maxDouble;
...
//
//    //  Реализуем перегруженные методы
//    static void max(com.draft_task1_3_8.MaxValue balalaika, String price, int b) {
//
////        String price = "199";  // если не закомментить, тогда не нужно входного параметра метода String price,
//        price = "199";
//        double priceDouble = Double.parseDouble(price);
...
//            Решение:\s""");
//
//        com.draft_task1_3_8.MaxValue_previous maxValue = new com.draft_task1_3_8.MaxValue_previous();
//
//        //  Вводим исходные значения
//        int b = 0;
//        String price = null;
...
//
//    //  Реализуем перегруженные методы
//    static void max(com.draft_task1_3_8.MaxValue_previous balalaika, String price, int b/*, String firstStr, String secondStr*/) {
//
//        price = "199";
//        double priceDouble = Double.parseDouble(price);
//        priceDouble += 50;
...
//
//    //  Реализуем перегруженные методы
//    static void max(com.draft_task1_3_8.MaxValue_previous maxValue, int price, int a/*, int x, int y*/) {
////        System.out.println("С методом max c переменными Integer: ");
////        if (x>y) {
////            int max = x;
...
//    }
//
//    static void max(com.draft_task1_3_8.MaxValue_previous balalaika, double price/*, double x, double y*/) {
////        System.out.println("С методом max c переменными Double: ");
////        if (x>y) {
////            double max = x;
////            System.out.println("Наибольшее значение имеет x = " + max);
...
//    }
//
//    static void max(com.draft_task1_3_8.MaxValue_previous baraban, String price, int b/*, String firstStr, String secondStr*/) {
...
//
//    //  Реализуем перегруженные методы
//    static void max(com.draft_task1_3_8.MaxValue_previous maxValue, int price, int x, int y) {
//        System.out.println("С методом max c переменными Integer: ");
//        if (x>y) {
//            int max = x;
//            System.out.println("Наибольшее значение имеет x = " + max);
...
//    }
//
//    static void max(com.draft_task1_3_8.MaxValue_previous printer, String price, String firstStr, String secondStr) {
//        System.out.println("С методом max c переменными String: ");
//        int x = firstStr.length();
//        int y = secondStr.length();
//        if (x>y) {
...
//    static void max(com.draft_task1_3_8.MaxValue_previous maxValue, int price) {
//        price = price + 50;
//        maxValue.price = price;
//    }
//
//    //        static void setPrinterPriceDouble(com.draft_task1_3_8.MaxValue_previous balalaika, int price) {
//    static void max(com.draft_task1_3_8.MaxValue_previous balalaika, double price) {
//        price = price + 50;
//        balalaika.price = price;
//    }
//
//    //    static void setPrinterPriceString (com.draft_task1_3_8.MaxValue_previous printer, String price) {
//    static void max(com.draft_task1_3_8.MaxValue_previous printer, String price) {
//        double priceDouble = Double.parseDouble(price);
//        priceDouble += 50;
//        printer.price = 50;
...
//
//    //    static void setPrinterPriceInt(com.draft_task1_3_8.MaxValue_previous printer, int price) {
//    static void setPrinterPrice(com.draft_task1_3_8.MaxValue_previous printer, int price) {
//        price = price + 50;
//        printer.price = price;
//    }
//
//    //    static void setPrinterPriceString (com.draft_task1_3_8.MaxValue_previous printer, String price) {
//    static void setPrinterPrice (com.draft_task1_3_8.MaxValue_previous printer, String price) {
//        double priceDouble = Double.parseDouble(price);
//        priceDouble += 50;
//        printer.price = 50;
//    }
