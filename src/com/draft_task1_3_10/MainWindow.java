...
//        Пример _ ППППППППППППППППППППППППППППППППППП  теперь совместить с другой инструкцией, третья часть закончена https://github.com/irinamore/snake_part3-final-/tree/master/src
